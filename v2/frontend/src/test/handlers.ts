...
export const handlers = [
  ...
  // The message catalogue. The real en.json (see testMessages), so a component that renders
  // a message asserts the same text a user sees.
  http.get(
