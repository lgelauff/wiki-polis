...
export const testMessages: Record<string, string> = {
  ...
  "accept-notify-email-unavailable": "Email notifications unavailable — no confirmed email on your wiki account. $1",
  ...
  "accept-privacy-window-a": "Between $1 and $2 after close, you may optionally and permanently link your username to your pseudonym in the public record. This is irreversible during that window.",
