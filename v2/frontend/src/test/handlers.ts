...
export const testMessages: Record<string, string> = {
  ...
  "base-language-label": "Language",
  'conv-col-yours': 'Yours',
  "accept-choose-pseudonym": "Choose a pseudonym",
  "accept-consent": "I understand my votes and arguments are recorded with this pseudonym, Proto keeps an internal username link while this consultation runs, and what I write is released under CC0.",
  "accept-js-error": "Could not generate new pseudonym options. Try again.",
  "accept-js-generating": "Generating new pseudonym options.",
  "accept-js-regenerated": "New pseudonym options generated. Selected $1.",
  "accept-js-selected": "Selected pseudonym $1.",
  "accept-js-taken": "That pseudonym was just taken — please choose another.",
  "accept-licence-heading": "What you write",
  "accept-licence-intro": "Statements and arguments you write here are released under $1, which places them in the public domain, the same as a wiki edit. That is what lets the results be published as a report, quoted in a discussion, and reused by anyone.",
  "accept-licence-scope": "This covers what you write, not who wrote it: contributions are published under your pseudonym, and CC0 does not require anyone to credit you. Your votes are not covered — a vote is a fact, not a work. CC0 cannot be withdrawn once given, the same as any wiki edit.",
  "accept-not-now": "Not now",
  "accept-notify-add-email": "Add one on Meta-Wiki",
  "accept-notify-email": "Email me if we send updates (via your confirmed wiki email address)",
  "accept-notify-email-unavailable": "Email notifications unavailable — no confirmed email on your wiki account. $1 and return to enable this.",
  "accept-notify-heading": "Stay informed",
  "accept-notify-talk": "Post to my talk page if we send updates",
  "accept-privacy-body1": "Your pseudonym is used for consultation records and participant-facing displays. Your Wikimedia username is used internally for login, access checks, moderation, and notification preferences.",
  "accept-privacy-body2": "Public results may include aggregate votes, clusters, and pseudonyms. They do not show your Wikimedia username unless you explicitly reveal it after the consultation closes.",
  "accept-privacy-details-summary": "Privacy & data handling",
  "accept-privacy-heading": "Privacy summary",
  "accept-privacy-summary": "Public records use your pseudonym. Proto keeps the username link internally for login, access checks, notifications, moderation, and privacy controls.",
  "accept-privacy-reveal-window": "Between <strong>$1</strong> and <strong>$2 {{PLURAL:$2|day|days}}</strong> after close, you may optionally and permanently link your username to your pseudonym in the public record. This is irreversible during that window.",
  "accept-crumb": "join",
  "accept-joining": "joining consultation",
  "accept-pick-name": "Pick the name you will use in this consultation.",
  "accept-pseudonym-help": "Other participants see this name next to your votes and arguments. Your Wikimedia username stays internal unless you reveal it after the consultation closes.",
  "accept-reroll": "↻ reroll",
  "accept-reroll-loading": "↻ loading…",
  "accept-notify-help": "Optional best-effort updates when the consultation closes or results are published.",
  "accept-submit": "Join consultation as $1 →",
  "accept-reroll-aria": "Generate new pseudonym options",
  "common-return-home": "Return home",
  "forbidden-elig-criteria": "Your account did not meet the configured criteria.",
  "forbidden-elig-doc-title": "Not eligible — $1 — Proto",
  "forbidden-elig-heading": "Not eligible for this consultation",
  "forbidden-elig-requirement": "This consultation has an eligibility requirement.",
  "forbidden-elig-requirement-named": "This consultation has an eligibility requirement: $1.",
  "forbidden-elig-unavailable": "The eligibility checker is unavailable right now. Try again later.",
  "accept-licence-link": "CC0",
  "base-admin-badge": "Admin",
  "base-admin-link": "admin",
  "base-dismiss": "Dismiss",
  "base-log-in": "log in",
  "base-log-out": "log out",
  "conv-demo-label": "Demo",
  "home-banner-open-issue": "Open an issue",
  "home-hero-heading": "Where the community actually stands.",
  "base-mode-switch-aria": "Choose demo or real mode",
  "base-mode-demo": "Try it out",
  "base-mode-real": "Real",
  "base-lock-real": "Real consultation",
  "base-footer-licence": "Statements and arguments are released under $1.",
  "fork-demo-title": "Try out the platform",
  "fork-demo-sub": "Demonstration conversations — try the full flow.",
  "fork-demo-cta": "Try it →",
  "fork-demo-aria": "Try out the platform — a demonstration conversation where you can try the full flow",
  "fork-real-title": "Participate in real consultations",
  "fork-real-sub": "Your votes count.",
  "fork-real-cta": "Participate →",
  "fork-real-aria": "Participate in real consultations — your votes count",
  "home-hero-body": "Vote on short statements, and suggest improvements. Learn how your views compare to other community members — which statements already have consensus, and what topics are divisive, and why.",
  "home-banner-prototype": "Prototype in active development — things may change. $1 if you find a bug.",
  ...
  "adminconv-assigned-count": "$1 {{PLURAL:$1|role assigned|roles assigned}}",
  ...
  "adminconv-confirm-delete": "Delete this consultation?\n\nThis removes local Proto records after hiding the Polis conversation. This cannot be undone.",
  ...
  "adminconv-doc-title": "Manage $1 — Proto",
  "adminconv-due-now": "due now",
  "adminconv-edit": "Edit",
  "adminconv-featured-count": "$1 {{PLURAL:$1|featured statement|featured statements}}",
  ...
  "adminconv-joined": "$1 {{PLURAL:$1|participant|participants}} joined",
  ...
  "adminconv-open-count": "$1 open {{PLURAL:$1|flag|flags}}",
  ...
  "adminconv-p6-seeded": "$1 of {{PLURAL:$2|$2 statement|$2 statements}} seeded.",
  "adminconv-p6-setup-label": "Informed voting — setup",
  "adminconv-participant-count-unavailable": "participant count unavailable",
  "adminconv-participant-excluded": "· $1 {{PLURAL:$1|participant|participants}} excluded",
  ...
  "adminconv-stmt-excluded": "$1 {{PLURAL:$1|statement|statements}} excluded",
  ...
  "report-shift-intro": "Each row compares the initial vote (Phase 2, before arguments) with the informed vote (Phase 6, after argument mapping). <strong>Shift</strong> is the change in population-level agree rate — a cross-round comparison of separate populations, not a matched individual delta (see $1 below).",
  ...
  'conv-unavailable-doc-title': 'Conversation unavailable — Proto',
  ...
  'conv-vote-you-voted': 'You voted: $1',
  ...
  'forbidden-invite-doc-title': 'Access restricted — Proto',
