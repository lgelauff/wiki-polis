...
export const testMessages: Record<string, string> = {
  ...
  "accept-licence-intro": "Statements and arguments you write here are released into the public domain ($1). That is what lets the results be published as a report, quoted in a discussion, and reused by anyone.",
  "accept-licence-scope": "This covers what you write, not who wrote it: contributions are published under your pseudonym, and CC0 does not require anyone to credit you. Your votes are not covered — a vote is a fact, not a work. CC0 cannot be withdrawn once given.",
