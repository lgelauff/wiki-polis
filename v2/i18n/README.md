...
| Piece | State |
|---|---|
| `en.json` + `qqq.json` (947 keys, 100% documented; 569 offered to translators, 378 held back) | ✅ committed |
...
| Locales offered to users (`ENABLED_LOCALES`) | English and Dutch (`nl.json`, 531 keys) |
