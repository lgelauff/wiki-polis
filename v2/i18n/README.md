...
| Piece | State |
|---|---|
| `en.json` + `qqq.json` (951 keys, 100% documented; 573 offered to translators, 378 held back) | ✅ committed |
...
| Locales offered to users (`ENABLED_LOCALES`) | English and Dutch (`nl.json`, 535 keys) |
