...
> pre-publication drafts** (flagged inline); links marked _coming_ don't exist yet.
...
- [Participant help](../guidance/pub_participant-help.md) — how voting works, writing statements / arguments (AI draft, pre-publication)
